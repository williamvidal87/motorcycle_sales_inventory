...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta name="csrf-token" content="{{ csrf_token() }}">
            ...
            <!-- Favicon -->
            <link rel="shortcut icon" href="{{ asset('image/logo/chokenz.jpg') }}">
            <link rel="icon" type="image/png" href="{{ asset('image/logo/chokenz.jpg') }}">
    ...
    <body id="page-top">
        ...
        @stack('product-category-table-scripts')
        @stack('inventory-table-scripts')
        @stack('purchase-product-table-scripts')
